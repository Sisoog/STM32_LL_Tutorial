...
////	
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
				...
				/* print out the voltages read from ADC that is stored in memory buffer  */
		Voltage = (float)(adc_read[j] * 3.3) / (4095);

		if(j == 0)
		printf("Voltage of Channel0 is: %0.4f v\r\n", Voltage);
		if(j == 1)
		printf("Voltage of Channel1 is: %0.4f v\r\n", Voltage);
